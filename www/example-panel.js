...
class ExamplePanel extends LitElement {
  ...
  render() {
    return html`
    <p id = "entitiy" style="color:#8db3e2;font-size:22px;"> <b> Security_Camera </b> </p>
    <p id = "attribute" style="font-size:12px;"> <b> Entities: ${Object.keys(this.hass.states)} </b> </p>

    <input id="toggle" type="button" value="off"></input>
